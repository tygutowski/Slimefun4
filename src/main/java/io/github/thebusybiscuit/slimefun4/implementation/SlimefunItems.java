...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack ZEUS_LIGHTNING = new SlimefunItemStack("ZEUS_LIGHTNING", Material.TRIDENT, "&cZeus' Lightning", "&eSoul-Rend", "", "&fSend out a powerful lightning to shock the ground beneath you and destroy your enemies with this godly power!");
    public static final SlimefunItemStack ENDER_WAND = new SlimefunItemStack("ENDER_WAND", Material.BLAZE_ROD, "&cEnder Wand", "&eSoul-Rend", "", "&Send any mob of your choosing to a random location. Will it be grassland, or a pit of lava... ?!");
